...
import {TextDrawer} from "ascii-diag-renderer";
import {AppState} from "../ui/app-state";
import {Constants, TextShape, Text} from "ascii-diag-renderer";
...
export class TextMoveTool implements Tool {
    ...
    constructor(layerService: LayerService, toolService: ToolService, selectBoxDrawer: SelectBoxDrawer,
        ...
        this.currentText = Text.Builder.from(this.currentShape).build();
